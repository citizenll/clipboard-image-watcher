...
1. 从 [Releases](https://github.com/citizenll/clipboard-image-watcher/releases) 下载最新版本
...
如果遇到问题或有功能建议，请在 [Issues](https://github.com/citizenll/clipboard-image-watcher/issues) 页面提交。
